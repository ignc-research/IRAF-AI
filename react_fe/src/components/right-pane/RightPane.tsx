...
import FileSelector, { SelectedFile } from '../shared/FileSelector';
...
function RightPane (){
    ...
    useEffect(() => {
        console.log(tabContext.weldingElement);
    }, [tabContext.weldingElement])

    const hasObjectAndConfig = Object.keys(tabContext.layers).length > 0 && tabContext.weldingElement.obj;
