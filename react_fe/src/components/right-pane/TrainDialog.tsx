...
export default function TrainDialog(props: { isOpen: boolean, setIsOpen: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    const onSave = async () => {
        try {
            ...
            const result = await new PoseEstimationApi().training(selectedModel);
